...
.footer, .footer-widget, .footer-widget-area, .footer-widget-area a, .footer ul.footer-widget-area li.footer-widget h2, .footer .footer-widget h3, .footer .footer-widget h3 a {
    color:<?php echo get_theme_mod( 'site_accent_text_color', '#fff' ); ?>;
}
